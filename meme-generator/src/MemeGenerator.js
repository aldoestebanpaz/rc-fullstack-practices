...
export class MemeGenerator extends React.Component {
  ...
  handleSubmit(event) {
    ...
    const newMemeUrl = this.state.allMemes[randomIndex].url;
    ...
    return(
      <>
        <form className="meme-form" onSubmit={this.handleSubmit}>
          <input type="text" name="top-input" placeholder="testo de arriba" onChange={this.handleChange} />
          <input type="text" name="bottom-input" placeholder="testo de abajo"  onChange={this.handleChange} />
